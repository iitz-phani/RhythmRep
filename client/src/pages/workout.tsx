  ...
  if (!workoutData) {
    return (
      <div className="min-h-screen bg-gray-900 pt-16">
        ...
        <div className="max-w-4xl mx-auto p-4 pt-8">
          <div className="text-center">
            <h1 className="text-2xl font-bold mb-4">No Workout Plan Selected</h1>
            <p className="text-gray-400 mb-6">Please select a workout plan to get started.</p>
            <Button onClick={() => setLocation("/plans")} className="fitness-button">
              Choose Workout Plan
            </Button>
          </div>
        </div>
